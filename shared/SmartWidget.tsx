...
export default function SmartWidget({
    ...
    return (
        ...
        >
            <div className="relative z-10 bg-black w-28 h-28 rounded-2xl flex justify-center items-center ">
                {title}
            </div>
            {tip && (
                <motion.div
                    className="absolute left-[-15%] text-white text-sm ease-in-out duration-500 rounded-full
                             bg-black w-5 h-9 flex justify-center items-center
            ...
            <div
                className="h-full rounded-2xl border-2 border-black absolute transform left-0 z-0 w-[210%] opacity-0
