...
export default function Header() {
    return (
        <header
            className="bg-gray-400 bg-opacity-10 backdrop-blur-lg flex justify-between items-center border-gray-400 border-[1px] rounded-full w-[70%]  mx-auto py-3 px-6 mt-5
