...
export default function Header() {
    return (
        <header
            className="bg-gray-950 bg-opacity-0 backdrop-blur-lg flex justify-between items-center border-gray-700 border-[1px] rounded-full w-[70%]  mx-auto py-3 px-6 mt-5
