...
export default function Header() {
    return (
        <header
            ...
            rounded-full sm:w-[50%]  mx-auto py-3 sm:px-6 sm:mt-5 transition-all ease-in duration-600  hover:border-gray-500 fixed left-[50%] 
		transform translate-x-[-50%] z-30 border-0 bg-none backdrop-filter-none px-0 w-[90%] justify-between mt-2 
		"
        >
