...
export const goalSchema = z.object({
    ...
    measurable: z.string().min(5, "Опишите, как измерить успех"),
    achievable: z.string().min(5, "Укажите, как цель достижима"),
    relevant: z.string().min(5, "Объясните актуальность цели"),
    timeBoundText: z
        .string()
